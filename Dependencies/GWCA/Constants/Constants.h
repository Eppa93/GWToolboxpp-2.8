...
namespace GW {
	namespace Constants {
		...
		enum HeroID : DWORD {
			Norgu = 1, NoHero, Goren, Tahlkora, MasterOfWhispers, AcolyteJin, Koss,
			Dunkoro, AcolyteSousuke, Melonni, ZhedShadowhoof, GeneralMorgahn, KeiranThackeray,
		...
		namespace SqrRange {
			...
			const float CoT = Range::CoT * Range::CoT;
